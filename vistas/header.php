...
<html>
  <head>
    ...
    <title>Ventas | www.notitle.com</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Ningun Nombre Porahora</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.anonymous.com - Desarrollando Software
                      <small>www.youtube.com/none</small>
                    </p>
                  </li>
